...
func TestThinkingE2EMatrix_Suffix(t *testing.T) {
	...
	cases := []thinkingTestCase{
		...
		// Case 14: Budget 0 → clamped to minimal → clampReasoningEffort maps minimal→low
		{
			name:        "14",
			from:        "claude",
			to:          "openai",
		...
		// Case 68: Budget 64000 → passthrough logic → xhigh → clampReasoningEffort maps xhigh→high
		{
			name:        "68",
			from:        "gemini",
			to:          "openai",
		...
		// Case 70: Budget -1 → passthrough logic → auto → clampReasoningEffort maps auto→medium
		{
			name:        "70",
			from:        "gemini",
			to:          "openai",
		...
		// Case 115: OpenAI to gpt-5.2, level xhigh → clampReasoningEffort maps xhigh→high (OpenAI format)
		{
			name:        "115",
			from:        "openai",
			to:          "github-copilot",
...
func TestThinkingE2EMatrix_Body(t *testing.T) {
	...
	cases := []thinkingTestCase{
		...
		// Case 14: thinking.budget_tokens=0 → clamped to minimal → clampReasoningEffort maps minimal→low
		{
			name:        "14",
			from:        "claude",
			to:          "openai",
		...
		// Case 68: thinkingBudget=64000 → xhigh → clampReasoningEffort maps xhigh→high
		{
			name:        "68",
			from:        "gemini",
			to:          "openai",
		...
		// Case 70: thinkingBudget=-1 → auto → clampReasoningEffort maps auto→medium
		{
			name:        "70",
			from:        "gemini",
			to:          "openai",
		...
		// Case 115: OpenAI to gpt-5.2, reasoning_effort=xhigh → clampReasoningEffort maps xhigh→high
		{
			name:        "115",
			from:        "openai",
			to:          "github-copilot",
